      ...
      >
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center rounded-[var(--radius-pill)] px-3 py-1.5 text-sm font-semibold text-[var(--color-brand-lilac-dark)] underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-plum)]"
          >
            ← Back to the sheet
          </Link>
        </div>
