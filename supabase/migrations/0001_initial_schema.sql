...
-- =============================================================================
--
-- This is the AUTHORITATIVE, applied migration — the file `npx supabase db
-- push` runs against the linked project. It is byte-for-byte the same
-- schema as `../schema.sql` (the human-readable reference copy kept at the
-- repo root of `supabase/` for easy review without digging into timestamped
-- migration files). If you change one, change the other and keep them in
-- sync — `schema.sql` documents the *current* state; this migration is the
-- historical record of how it was reached.
--
-- Generated: 2026-08-31 (authored by the db-schema agent, no live project).
-- =============================================================================
