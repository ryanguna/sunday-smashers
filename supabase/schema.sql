...
-- -----------------------------------------------------------------------------
-- checklist_items — loot bag / medal / trophy / prize money per player
-- -----------------------------------------------------------------------------
...
-- Distinct from checklist_items, which is per-player loot bag/medal handout.
-- -----------------------------------------------------------------------------
...
comment on table public.committee_checklist is
  ...
  'checklist_items, which tracks per-player loot bag/medal handout.';
...
-- ===========================================================================
-- Migration 0011 — committee-controlled page visibility. Applied verbatim;
-- see supabase/migrations/0011_site_page_visibility.sql for the rationale.
-- ===========================================================================
...
-- ===========================================================================
-- Migration 0012 — drop profiles.shirt_size. The organisers stopped asking
-- players for a t-shirt size, so the column and every feature derived from it
